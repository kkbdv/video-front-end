...
Page({
  ...
  onLoad: function (params) {    
    ...
    wx.request({
      ...
      success: function(res) {
        ...
        if (publisher.faceImage == undefined || publisher.faceImage == null || publisher.faceImage==''){
          publisher.faceImage ="/noneface.png";
          me.setData({
            serverUrl: serverUrl,
            publisher: publisher,
  ...
  showPublisher: function () {
    ...
    if (user == null || user == undefined || user == '') {
      ...
      if(videoInfo.userId==user.id){//判断是否自己
        // wx.navigateTo({
        //   url: '../mine/mine',
        // })
        wx.switchTab({
         ...
         wx.navigateTo({
           url: '../mineNavigate/mine?publisherId=' + videoInfo.userId,
         })
        // wx.switchTab({
  ...
  onShareAppMessage: function (res) {
    ...
    return {
      title: videoInfo.videoDesc == null ? "高校分享" : videoInfo.videoDesc,
